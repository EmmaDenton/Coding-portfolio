        ...
        <div id="hero-card" className="card">
          <div className="card-content" id="hero-card-container">
            <div id="hero-img-container">
              ...
              <img id="hero-project-image" src="./src/assets/Workscheduler.png" alt="Description" />
            </div> 
...
The user can input text into the center column for each hour. They can click the blue save button to save their entry to the their local storage.</div>
          ...
          <div id="card-container">
            <div className="card" id="card-1">
              <div className="card-content">
                ...
                <img className="project-image" src="./src/assets/CalShare-screenshot-01.png" alt="Deployed calendar sharing application" />
          ...
          <div className="card" id="card-2">
            <div className="card-content">
              ...
              <img className="project-image" src="./src/assets/notetaker.png" alt="Deployed note taker application" />
          ...
          <div className="card" id="card-3">
            <div className="card-content">
              ...
              <img className="project-image" src="./src/assets/notetaker.png" alt="Description" />
          ...
          <div className="card" id="card-4">
            <div className="card-content">
              ...
              <img className="project-image" src="./src/assets/Texteditor.png" alt="Deployed text editor application" />
              <div className="card-subtitle">Node/MongoDB</div>
          ...
          <div className="card" id="card-5">
            <div className="card-content">
              ...
              <img className="project-image" src="./src/assets/gamegenius.jpg" alt="Deployed Game search application" />
              <div className="card-subtitle">HTML/CSS/Javascript</div>
